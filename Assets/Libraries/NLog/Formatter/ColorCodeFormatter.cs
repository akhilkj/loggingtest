...
namespace NLog {
    public class ColorCodeFormatter {
        ...
        static readonly Dictionary<LogLevelSet, string[]> colors = new Dictionary<LogLevelSet, string[]> {
            { LogLevelSet.Trace, new [] { FG_White,  BG_Cyan } },
            { LogLevelSet.Debug, new [] { FG_Blue,   BG_None } },
            { LogLevelSet.Info,  new [] { FG_Green,  BG_None } },
            { LogLevelSet.Warn,  new [] { FG_Yellow, BG_None } },
            { LogLevelSet.Error, new [] { FG_White,  BG_Red } },
            { LogLevelSet.Fatal, new [] { FG_White,  BG_Magenta } }
        };
